...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="lblError" runat="server" CssClass="mylabel" 
        Style="position:absolute;top:280px; left:13px;" Font-Bold="True" 
        ForeColor="Red"></asp:Label>
     <asp:Label ID="lblMessage" runat="server" CssClass="mylabel" 
        Style="position:absolute;top:320px; left:13px;" Font-Bold="True" 
        ForeColor="Red"></asp:Label>
     <asp:Label ID="lblEmployee" runat="server" Text="Employee:" 
        Style="position:absolute; top: 350px; left: 30px;" CssClass="mylabel"></asp:Label>
