...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:DropDownList ID="dropEmployee" runat="server" CssClass="mytextbox"         
        Style="position:absolute; top: 340px; left: 80px; height: 18px; width: 188px;" 
    ...
    <asp:Label ID="lblError" runat="server" CssClass="mylabel" 
        Style="position:absolute;top:300px; left:30px;" Font-Bold="True" 
        ForeColor="Red"></asp:Label>
     <asp:Label ID="lblMessage" runat="server" CssClass="mylabel" 
        Style="position:absolute;top:370px; left:30px;" Font-Bold="True" 
        ForeColor="Red"></asp:Label>
     <asp:Label ID="lblEmployee" runat="server" Text="Employee:" 
        Style="position:absolute; top: 340px; left: 11px;" CssClass="mylabel"></asp:Label>
     <asp:GridView ID="gridPayslips" runat="server" 
        Style="position:absolute; top: 380px; left: 30px;" CellPadding="4" 
    ...
    <asp:LinkButton ID="lnkGeneratePayslip" runat="server" 
        Style="position:absolute; top: 340px; left: 277px; height: 14px; width: 130px;" 
