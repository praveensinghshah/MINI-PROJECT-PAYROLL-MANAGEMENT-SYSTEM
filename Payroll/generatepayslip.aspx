...
<asp:Label ID="lblError" runat="server" CssClass="mylabel" 
        Style="position:absolute;top:260px; left:13px;" Font-Bold="True" 
        ForeColor="Red"></asp:Label>
    <asp:Label ID="lblPageTitle" runat="server" Text="Generate Payslip:" 
        Style="position:absolute; top: 285px; left: 11px;" CssClass="mylabel" 
        Font-Bold="True" Font-Size="14px" ForeColor="Red"></asp:Label>
    <asp:Label ID="lblEmployee" runat="server" 
        Style="position:absolute; top: 310px; left: 160px;" CssClass="mylabel" 
        Font-Bold="True"></asp:Label>
     <asp:Label ID="LabelEmployee" runat="server" Text="Employee:" 
        Style="position:absolute; top: 310px; left: 11px;" CssClass="mylabel"></asp:Label>
     <asp:Label ID="lblMonth" runat="server" Text="Month:" 
        Style="position:absolute; top: 335px; left: 11px;" CssClass="mylabel"></asp:Label>
     <asp:DropDownList ID="dropMonth" runat="server" CssClass="mytextbox"         
        Style="position:absolute; top: 335px; left: 160px; height: 14px; width: 95px;" 
    ...
    <asp:DropDownList ID="dropYear" runat="server" CssClass="mytextbox"         
        Style="position:absolute; top: 335px; left: 255px; height: 13px; width: 78px;" 
     ...
     <asp:Label ID="LabelBasicSalary" runat="server" Text="Basic Salary:" 
        Style="position:absolute; top: 360px; left: 11px; height: 14px;" 
        CssClass="mylabel"></asp:Label>
     <asp:Label ID="lblBasicSalary" runat="server" 
        Style="position:absolute; top: 360px; left: 160px; " 
        CssClass="mylabel"></asp:Label>
      <asp:Label ID="lblSalaryPerDay" runat="server" 
        Style="position:absolute; top: 410px; left: 160px; " 
        CssClass="mylabel"></asp:Label>
     <asp:Label ID="lblDeductionForLeaves" runat="server" 
        Style="position:absolute; top: 435px; left: 160px; " 
        CssClass="mylabel"></asp:Label>
    ...
    <asp:RangeValidator ID="RangeValidator1" runat="server" 
     ...
     <asp:Label ID="LabelNoOfLeaves" runat="server" Text="No. of Leaves:" 
        Style="position:absolute; top: 385px; left: 11px;" CssClass="mylabel"></asp:Label>
    <asp:TextBox ID="txtNoOfLeaves" runat="server" 
        Style="position:absolute; top: 385px; left: 160px; width: 34px;" 
    ...
    <asp:Label ID="LabelSalaryPerDay" runat="server" Text="Salary Per Day:" 
        Style="position:absolute; top: 410px; left: 11px;" CssClass="mylabel"></asp:Label>
     <asp:Label ID="LabelDeductionForLeaves" runat="server" Text="Deduction for Leaves:" 
        Style="position:absolute; top: 435px; left: 11px;" CssClass="mylabel"></asp:Label>
     <asp:Label ID="LabelNetSalary" runat="server" Text="Net Salary:" 
        Style="position:absolute; top: 460px; left: 11px;" CssClass="mylabel"></asp:Label>
    <asp:Button ID="btnSubmit" runat="server" Text="Submit" 
        Style="position:absolute; top: 485px; left: 13px;" BackColor="#009933" 
